...
4. **Rendimiento (P2 de QA):** PageSpeed ya se ejecutó el 19 de septiembre de 2026 a las 21:29 GMT-6: escritorio 100 (FCP 0,4 s, LCP 0,6 s) y móvil 92 (FCP 1,4 s, LCP 3,3 s, TBT 10 ms, CLS 0,002). No hay CrUX. La ruta pública tuvo TTFB único de 2,24–2,68 s, que incluye DigitalOcean y ERP. Falta instrumentar servidor/ERP, repetir muestras y resolver el recurso bloqueante estimado por PageSpeed (870 ms en móvil) con el detalle del audit, antes de modificar caché.
